                                                ...
                                                <tr>
                                                    <td className="p-1 whitespace-nowrap">
                                                        <div className="flex items-center font-bold text-gray-800 dark:text-gray-50">
                                                            ...
                                                            <div className="text-right">Bill No :</div>
                                                        </div>
                                                    </td>
                                                    <td className="p-1 whitespace-nowrap">
                                                ...
                                                <tr>
                                                    <td className="p-1 whitespace-nowrap">
                                                        <div className="flex items-center font-bold text-gray-800 dark:text-gray-50">
                                                            ...
                                                            <div className="text-right">Bill Status :</div>
                                                        </div>
                                                    </td>
                                                    <td className="p-1 whitespace-nowrap">
                                                ...
                                                <tr>
                                                    <td className="p-1 whitespace-nowrap">
                                                        <div className="flex items-center font-bold">
                                                            ...
                                                            <div className="text-right">Table No :</div>
                                                        </div>
                                                    </td>
                                                    <td className="p-1 whitespace-nowrap">
                                                        <div className="text-left">
                                ...
                                <div className="overflow-x-auto overflow-scroll max-h-[calc(100vh-24rem)] h-auto px-2 py-2">
                                    <table className="w-full table-auto">
                                        ...
                                        <tbody className="divide-y divide-gray-100 text-sm">
                                            {orderItems.length < 1 ? (
                                                <tr>
                                                    <td colSpan="5" className="text-center text-gray-400 py-4">No items were found.</td>
                                                </tr>
                                            ) : (
                                        ...
                                        {paymentMethod === 'cash' && (
                                            <div>
                                                <div className="flex items-center justify-between mt-1">
                                                    <p className="text-md font-bold">Cash Amount</p>
                                                    <input
                                                        className="w-1/2 appearance-none block bg-transparent border border-gray-300 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500 dark:bg-transparent dark:border-gray-600 dark:text-white dark:focus:bg-gray-700 dark:focus:border-gray-500"
                                                        type="number"
                                                ...
                                                <div className="flex items-center justify-between mt-1">
                                                    <p className="text-md font-bold">Remaining Amount</p>
                                                    <div>
                                                        {isNaN(parseFloat(cashAmount)) ? (
                                                            <p className="mb-1 text-lg font-bold">LKR {cashAmount}</p>
                                                        ) : (
                                                            <p className="mb-1 text-lg font-bold">LKR {(parseFloat(cashAmount) - totalAfterDiscount).toFixed(2)}</p>
                                                        )}
                                                    </div>
                                                </div>
                                            </div>
