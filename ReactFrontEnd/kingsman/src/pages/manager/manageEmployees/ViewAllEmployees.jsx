            ...
            <div className='mx-auto px-3 py-2 flex justify-between items-center bg-white dark:bg-gray-700 rounded-lg shadow-md'>
                ...
                <div className="flex items-center">
                    ...
                    <div className='flex-grow px-4 py-2 border rounded-full dark:bg-gray-600 '>
                        <input type="search" placeholder="Search Employee..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} id="search" className='flex-grow px-4 py-0 border-none outline-none focus:ring-0 dark:bg-gray-600 dark:text-white' />
                    </div>
                    ...
                    {/* Add Employee button */}
                    <Link to="/manager?tab=new-employee" className="bg-green-500 hover:bg-green-900 text-white font-bold py-2 ml-2 rounded px-2 w-full text-center">Add Employee</Link>
                </div>
            </div>

            {/* Table */}
            <div className="relative overflow-x-auto mt-5 bg-white dark:bg-gray-800 shadow-md rounded-lg">
                <table className="w-full table-auto text-gray-700 dark:text-white-400 border-collapse bg-gray-50 ">
                    <thead className="text-gray-700 text-sm uppercase bg-gray-200 dark:bg-gray-700 dark:text-gray-700">
