...
const AddPositionModal = ({ isOpen, onClose, onAddPosition }) => {
  ...
  return (
    <Modal show={isOpen} size="md" onClose={onClose} popup>
      <Modal.Header>
        <h3 className="text-xl font-medium text-gray-900 dark:text-white">Add New Position</h3>
      </Modal.Header>
      <Modal.Body>
        <div className="space-y-6">
          ...
          <div className="w-full">
            <Button onClick={handleAddPosition} className='bg-green-500 hover:bg-green-600'>Add Position</Button>
          </div>
        </div>
      </Modal.Body>
    </Modal>
