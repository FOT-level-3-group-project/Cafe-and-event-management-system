...
function AttendanceFrManager() {
  ...
  return (
    <div className="flex flex-col w-full bg-gray-200">
      <div className="mt-7 mr-10 ml-5">
        {/* Filter controls */}
        <div className="flex items-center justify-between border-b pb-2 bg-white rounded-lg shadow-md">
          {/* Dropdown for Name */}
          <div className="flex gap-4 mt-3 mb-2 ml-4">
            <div>
