...
const GenerateTicketPriceModal = ({ show, onClose, onTicketPriceChange }) => {
  ...
  const calculateTicketPrice = () => {
    ...
    // }
    if (empSalary === '') {
      setErrorMessage('Please enter the employee salary');
      return;
    }
    if (electricityBill === '') {
      setErrorMessage('Please enter the estimated electricity bill');
      return;
    }
    if (waterBill === '') {
      setErrorMessage('Please enter the estimated water bill');
      return;
    }
    if (inventory === '') {
